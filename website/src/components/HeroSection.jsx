  ...
  return (
    <Box id={id} className="hero-section section">
      ...
      <Typography variant="body1" className="hero-desc" align="center" sx={{ mt: 2 }}>
        LockAI is a compact, intelligent access control system that enhances physical security using a dual-factor verification system based on knock patterns and finger count. It leverages embedded AI (TinyML) on an ESP32 microcontroller to identify valid touch sequences across three capacitive sensors, eliminating the need for microphones and ensuring robust operation even in noisy environments. Real-time connectivity, logging to Firebase, and mobile visualization via Blynk make LockAI a customizable, low-cost, IoT-enabled smart locking solution for lockers, drawers, and personal security systems.
      </Typography>
    </Box>
  );
}
